...
(function () {
    ...
    angular.module('client.services').factory('blogPostService', BlogPostService);
    ...
    function BlogPostService($http, $q) {
        ...
        function readAll() {
            return $http.get('/api/myBlogPosts').then(function (dateChange) {
                return convertAllDates(dateChange);
            }).catch(onError);
        }

        function readById(id) {
            return $http.get('/api/myBlogPosts/' + id).then(function (dateChange) {
                return convertAllDates(dateChange);
            }).catch(onError);
        }

        function create(data) {
            return $http.post('/api/myBlogPosts', data).then(xhrSuccess).catch(onError);
        }

        function update(data) {
            return $http.put('/api/myBlogPosts/' + data._id, data).then(xhrSuccess).catch(onError);
        }

        function _delete(id) {
            return $http.get('/api/myBlogPosts/' + id).then(xhrSuccess).catch(onError);
        }
        ...
        function convertAllDates(dateChange) {
            for (var x = 0; x < dateChange.data.items.length; x++) {
...
(function () {
    ...
    angular.module('client.services').factory('blogCategoryServices', BlogCategoryService);
    ...
    function BlogCategoryService($http, $q) {
        ...
        function readAll() {
            return $http.get('/api/blogCategories').then(xhrSuccess).catch(onError);
        }

        function readById(id) {
            return $http.get('/api/blogCategories/' + id).then(xhrSuccess).catch(onError);
        }

        function create(data) {
            return $http.post('/api/blogCategories', data).then(xhrSuccess).catch(onError);
        }

        function update(data) {
            return $http.put('/api/blogCategories/' + data._id, data).then(xhrSuccess).catch(onError);
        }
...
(function () {
    ...
    angular.module('client.services').factory('messageService', MessageService);
    ...
    function MessageService($http, $q) {
        ...
        function readAll() {
            return $http.get('/api/myMessages').then(xhrSuccess).catch(onError);
        }

        function readById(id) {
            return $http.get('/api/myMessages/' + id).then(xhrSuccess).catch(onError);
        }

        function create(data) {
            return $http.post('/api/myMessages', data).then(xhrSuccess).catch(onError);
        }

        function update(data) {
            return $http.put('/api/myMessages/' + data._id, data).then(xhrSuccess).catch(onError);
        }

        function _delete(id) {
            return $http.delete('/api/myMessages/' + id).then(xhrSuccess).catch(onError);
        }
